...
<head>
  <!-- META DATA -->
	...
	<link rel="stylesheet" href="css/Customer/lightbox.css">
			...
			<div class="container">
				<div class="row heading">
					 <div class="col-lg-12">	
	                    <h2>OUR BLOG</h2>
	                    <hr class="line02">
                    	<div class="intro">Lets Discover and Decide</div>
	                </div>
				</div>
				<div class="row">
					...
					<div class="post" style="background: #fff;">
						<div class="col-lg-6" style="padding: 0;">
							 <img src="{{url('/images/'.$blog->image)}}"  style="height: 390px;width:500px;"/>
						</div>
						<div class="col-lg-6">
							<div class="t-center" style="padding: 70px 0;">
								<h5 style="margin-bottom:40px;">{{$blog->title}}</h5>
								<p>{{Str::limit($blog->body, 350,$end='.......')}}</p>
